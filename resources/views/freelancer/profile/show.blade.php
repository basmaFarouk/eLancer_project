		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image freelancer-avatar"><img src="{{$user->profile_photo_url}}" alt=""></div>
						<div class="header-details">
							<h3>{{$user->name}} <span>{{$user->freelancer->title}}</span></h3>
							<ul>
								<li><div class="star-rating" data-rating="5.0"></div></li>
								<li><img class="flag" src="images/flags/de.svg" alt=""> {{$user->freelancer->country}}</li>
	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p>{{$user->freelancer->description}}</p>
		...
		<div class="col-xl-4 col-lg-4">
			<div class="sidebar-container">
				...
				<div class="profile-overview">
					<div class="overview-item"><strong>{{$user->freelancer->hourly_rate}}$</strong><span>Hourly Rate</span></div>
				...
				<div class="sidebar-widget">
					...
					<div class="attachments-container">
                        <a href="{{asset('uploads/'.$user->freelancer->attachment)}}" class="attachment-box ripple-effect" >Download CV</a>

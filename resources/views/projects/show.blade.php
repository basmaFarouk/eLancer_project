		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="single-company-profile.html"><img src="{{$project->project_photo_url}}" alt=""></a></div>
			...
			<div class="popup-tab-content" id="tab">
				...
				<form method="post" action="{{route('freelancer.proposals.store',$project->id)}}" id="apply-now-form">
					...
					<div class="input-with-icon-left">
						...
						<x-form.textarea  class="input-text with-border" name="description" id="description" placeholder="Description" required="required"/>
					</div>
                    ...
                    <div class="input-with-icon-left">
                        ...
                        <x-form.select  class="input-text with-border" name="duration_unit" id="duration_unit" :options='$units' required="required"/>
					</div>
				</form>

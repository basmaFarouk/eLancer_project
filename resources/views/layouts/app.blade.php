		...
		<div class="container">
			...
			<div class="right-side">
				...
				<div class="header-widget">
                    {{-- {{dd(auth()->user()->freelancer->profile_photo_path)}} --}}
					<!-- Messages -->
					<div class="header-notifications user-menu">
						<div class="header-notifications-trigger">
                            {{-- @if (auth()->user()->freelancer->profile_photo_path) --}}

							<a href="#"><div class="user-avatar status-online"><img src="{{auth()->user()->profile_photo_url}}" alt=""></div></a>
                            {{-- @endif --}}


                            {{-- @if (auth()->user()->freelancer->profile_photo_path ==null)

                            <a href="#"><div class="user-avatar status-online"><img src="{{asset('profile/default.jpeg')}}" alt=""></div></a>
                            @endif --}}
						</div>
